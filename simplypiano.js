...
[rewrite_local]
#simply piano
^https:\/\/alicdn\.joytunescn\.com\/server\/asla\/accounts\/accountAuthenticate url script-response-body https://raw.githubusercontent.com/echo66677/myself/master/simplypiano.js
[mitm]
...
#[Script]
# Simply Piano
#simply piano = type=http-response,pattern=^https:\/\/alicdn\.joytunescn\.com\/server\/asla\/accounts\/accountAuthenticate,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/echo66677/myself/master/simplypiano.js,script-update-interval=0
#[MITM]
